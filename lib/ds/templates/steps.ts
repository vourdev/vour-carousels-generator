...
export const stepCardPartial = String.raw`<div class="card card-amber" style="padding:18px 22px;display:flex;align-items:flex-start;gap:16px">
      <div style="min-width:36px;height:36px;border-radius:50%;background:#E94B19;color:#FFF;display:flex;align-items:center;justify-content:center;font-family:'Sora',sans-serif;font-weight:700;font-size:18px;flex:none">{{stepN}}</div>
      <div>
        <div style="font-family:'Sora',sans-serif;font-weight:700;font-size:26px;color:#1F0904;line-height:1.2">{{stepTitle}}</div>
        <div style="font-family:'Nunito',sans-serif;font-weight:500;font-size:22px;color:#7A6A5E;margin-top:4px;line-height:1.3">{{stepBody}}</div>
      </div>
    </div>`;
