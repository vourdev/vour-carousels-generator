...
export const calloutTemplate = String.raw`<div class="diag-wrap mt-40">
    <div style="background:#1F0904;border-radius:20px;padding:26px 30px;display:flex;align-items:flex-start;gap:20px;width:100%">
      ...
      <div style="font-family:'Nunito',sans-serif;font-weight:600;font-size:26px;color:#FAF5EF;line-height:1.4;word-break:break-word">{{calloutText}}</div>
    </div>
  </div>`;
