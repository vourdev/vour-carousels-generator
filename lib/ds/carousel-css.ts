...
export const carouselCss = String.raw`
  ...
  *, *::before, *::after { box-sizing: border-box; }
  ...
  h1 .a   { color: #EE4B1A; }                                    /* the orange accent word — exactly ONE per headline */
  ...
  .catatan-label {
    ...
    letter-spacing: 0.18em; text-transform: uppercase; color: #EE4B1A;
  }
  .catatan-body {
  ...
  .diag-bars .panel .foot {
    font-family: 'JetBrains Mono'; font-weight: 500; font-size: 22px;
    letter-spacing: 0.14em; text-transform: uppercase; color: #EE4B1A;
  ...
  .diag-icon-hub .tool .glyph svg { width: 100%; height: 100%; stroke: #1C0A05; stroke-width: 1.5; fill: none; stroke-linecap: round; stroke-linejoin: round; }
  ...
  /* Terminal code block */
  .terminal { background: #14110E; border-radius: 20px; padding: 36px 40px; color: #fff; font-family: 'JetBrains Mono'; width: 100%; }
  ...
  .terminal-body .kw  { color: #FF6A3D; }
  .terminal-body .str { color: #B79CF2; }
  .terminal-body .num { color: #7FD0A0; }
  ...
  .perm-user .avatar .crown { position: absolute; bottom: -4px; right: -4px; width: 28px; height: 28px; background: #EE4B1A; color: #fff; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 16px; font-family: 'Sora'; font-weight: 700; }
  ...
  .mock-btn { background: #EE4B1A; color: #fff; border-radius: 12px; padding: 12px 16px; font-family: 'Sora'; font-weight: 700; font-size: 20px; text-align: center; }
  ...
  .mock-lock { display: inline-flex; align-items: center; gap: 12px; padding: 14px 22px; border-radius: 999px; background: #14110E; color: #fff; font-family: 'JetBrains Mono'; font-weight: 500; font-size: 20px; letter-spacing: 0.08em; text-transform: uppercase; box-shadow: 0 12px 32px rgba(28,10,5,0.28); }
